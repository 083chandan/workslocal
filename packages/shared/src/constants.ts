...
export const MAX_TUNNELS_ANONYMOUS = 2;
export const MAX_TUNNELS_AUTHENTICATED = 5;
export const STALE_THRESHOLD_DAYS = 30; // 30 days (authenticated)
export const SUBDOMAIN_RESERVATION_MS = 30 * 60 * 1000; // Subdomain reservation time: 30 minutes (anonymous)
export const MAX_REQUESTS_PER_TUNNEL = 1000;
export const API_KEY_PREFIX = 'wl_k_';
export const API_VERSION = 'v1';
export const ANONYMOUS_TUNNEL_TTL_MS = 2 * 60 * 60 * 1000; // Anonymous tunnel time-to-live: 2 hours
export const AUTH_CACHE_TTL_SECONDS = 3600; // 1 hour KV cache
